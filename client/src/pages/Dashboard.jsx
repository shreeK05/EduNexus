...
import {
  ...
  BookMarked, Bell, Settings, Sparkles, Terminal
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 flex font-sans selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <aside className="w-72 bg-slate-900/50 backdrop-blur-2xl border-r border-slate-800/50 hidden lg:flex flex-col fixed h-full z-50">
        ...
        <nav className="flex-1 px-4 space-y-2 mt-4">
          ...
          <NavItem icon={<Users size={20} />} label={isTeacher ? "Students" : "Classmates"} />
...
const NavItem = ({ icon, label, active, badge }) => (
  <button className={`w-full flex items-center justify-between px-4 py-3.5 rounded-2xl transition-all group duration-300
